...
from env.mobile_handover_env import Observation
...
class BasePolicy:
    ...
    def base_reset(self):
        ...
        self.grasped = False
        self.retreat_step = 0
        self.last_action = self.init_joint
        self.last_action_type = "joint"
        self.cfg.goal_center = (0.61, -0.20, 1.25)
        self.refresh_goal_center = False
    ...
    def run_policy(self, observation: Observation):
        if not self.init:
            ...
            if self.wait_steps > 0:
                ...
                self.last_action, self.last_action_type = action, action_type
        ...
        if self.refresh_goal_center is False:
            self.cfg.goal_center = (observation.joint_positions[0], observation.joint_positions[1], 1.20)
            observation.env.status_checker.cfg.goal_center = self.cfg.goal_center
            self.refresh_goal_center = True
