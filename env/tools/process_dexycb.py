...
"""
# cd /share/haoran/HRI/OMG-Planner/data/grasps/simulated
# tar -cf /share1/junyu/HRI/genh2r/env/data/tmp/ycb_grasps.tar.gz *.npy
# cd /share1/junyu/HRI/genh2r/env/data/tmp/
